      ...
      {isVisible && (
        <div className="ds-dropdown" onClick={hideDropdown}>
          {isAuthenticated ? (
            <>
              ...
              <div className="ds-dropdown-content">
                <ul>
                  ...
                  <li>
                    <Link to="/logout" className="ds-link ds-text ds-text-variant__paragraph ds-link__dark ds-text-size__l">
            ...
            <>
              <Link to="/login" className="ds-link ds-text ds-text-variant__paragraph ds-link__dark ds-text-size__l">
              ...
              <Link to="/register" className="ds-link ds-text ds-text-variant__paragraph ds-link__dark ds-text-size__l">
                <span className="ds-icon outline-log-in ds-icon-size__m"></span>
