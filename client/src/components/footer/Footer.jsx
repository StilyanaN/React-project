...
>
  <div className="container text-center py-5">
    <div className="row">
      ...
      <div className="col-12 mb-4">
        <a className="btn btn-outline-secondary btn-social mr-2" href="http://www.x.com/">
          <i className="fab fa-twitter" />
        </a>
        <a className="btn btn-outline-secondary btn-social mr-2" href="http://www.facebook.com/">
          <i className="fab fa-facebook-f" />
        </a>
        <a className="btn btn-outline-secondary btn-social mr-2" href="http://www.linkedin.com/">
          <i className="fab fa-linkedin-in" />
        </a>
        <a className="btn btn-outline-secondary btn-social" href="http://www.instagram.com/">
